...
class Forecast{
  ...
  String getIconPath(){
    ...
    } else if ((shortForecast.toLowerCase().contains("showers")) || (shortForecast.toLowerCase().contains("rain"))){
    ...
    } else if ((shortForecast.toLowerCase().contains("frost")) || (shortForecast.toLowerCase().contains("sleet"))){
