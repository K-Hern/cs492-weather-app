...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // TODO-DONE: Add a new list of forecast.Forecast variable called _forecasts
  ...
  void getForecasts(location.Location currentLocation) async {
     var forecastsList = await forecast.getForecastFromPoints(currentLocation.latitude, currentLocation.longitude);

    setState(() {
      _forecasts = forecastsList; 
    });
  }
  ...
  void setLocation() async {
    if (_currentLocation == null){
      ...
      // TODO-COMPLETE: Add a call to your getForecasts function passing in the currentLocation
